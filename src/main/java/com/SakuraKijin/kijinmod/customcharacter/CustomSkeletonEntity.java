...
public class CustomSkeletonEntity extends SkeletonEntity {
    ...
    public boolean canAttack(LivingEntity entity) {
        LivingEntity targetmob = ItemSkeletonStick_Lv1.SUMMONER.getLastHurtMob();
        if(entity instanceof PlayerEntity){
            if(entity.getStringUUID().equals(ItemSkeletonStick_Lv1.SUMMONERUUID)){
                return false;
            }
            else{
                return true;
    ...
    protected void customServerAiStep() {
        ...
        LivingEntity summoner = ItemSkeletonStick_Lv1.SUMMONER;
