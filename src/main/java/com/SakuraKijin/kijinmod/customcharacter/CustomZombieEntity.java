...
public class CustomZombieEntity extends ZombieEntity {
    ...
    public boolean canAttack(LivingEntity entity) {
        customent = entity;
        LivingEntity targetmob = ItemZombieStick_Lv1.SUMMONER.getLastHurtMob();
        if(entity instanceof PlayerEntity){
            if(entity.getStringUUID().equals(ItemZombieStick_Lv1.SUMMONERUUID)){
                return false;
            }
            else{
                return true;
    ...
    protected void customServerAiStep() {
        ...
        LivingEntity summoner = ItemZombieStick_Lv1.SUMMONER;
